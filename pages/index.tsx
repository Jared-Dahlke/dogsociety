				...
				<div className='mx-auto max-w-2xl py-32 sm:py-48 lg:py-56'>
					...
					<div className='text-center'>
						...
						<p className='mt-6 text-lg leading-8 text-gray-300'>
							Waiver hosting solution for your business. Get started today.
						</p>
						<div className='mt-10 w-lg flex items-center justify-center'>
							<a
								href='mailto:jared.dahlke@protonmail.com'
								className='rounded-md w-2/5 bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400'>
								Get started
							</a>
							{/* <a
								href='#'
